                ...
                public void onClick(View v) {
                    new DatePickerDialog(AddActivity.this, new DatePickerDialog.OnDateSetListener() {
                        ...
                        public void onDateSet(DatePicker view, int year, int monthOfYear,
                                              int dayOfMonth) {
                            textView_startDate.setText(MyPickerDialog.getDate(year, monthOfYear, dayOfMonth));
                        }
            ...
            textView_endDate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    new DatePickerDialog(AddActivity.this, new DatePickerDialog.OnDateSetListener() {
                        ...
                        public void onDateSet(DatePicker view, int year, int monthOfYear,
                                              int dayOfMonth) {
                            textView_endDate.setText(MyPickerDialog.getDate(year, monthOfYear, dayOfMonth));
                        }
                    }, year_0, month_0, day_0).show();
                }
            });
                ...
                public void onClick(View v) {
                    new TimePickerDialog(AddActivity.this, new TimePickerDialog.OnTimeSetListener() {
                        ...
                        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                            textView_startTime.setText(MyPickerDialog.getTime(hourOfDay, minute));
                        }
            ...
            textView_endTime.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    new TimePickerDialog(AddActivity.this, new TimePickerDialog.OnTimeSetListener() {
                        @Override
                        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                            textView_endTime.setText(MyPickerDialog.getTime(hourOfDay, minute));
                        }
...
class MyPickerDialog {
    ...
    public static String getDate(int year, int monthOfYear, int dayOfMonth) {
        ...
        return year + "年" + monthOfYear + "月" + dayOfMonth + "日星期"
                + weekEtoC[calendar.get(Calendar.DAY_OF_WEEK)];
    }
...
class MyDatePickerDialog extends MyPickerDialog {
    ...
    public void show() {
        ...
        new DatePickerDialog(context, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear,
                                  int dayOfMonth) {
                textView.setText(MyPickerDialog.getDate(year, monthOfYear,
                        dayOfMonth));
            }
